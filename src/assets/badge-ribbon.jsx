  ...
  return (
    <div className='flex justify-center'>
      ...
      >
        ...
        <path opacity='0.7' d='M0 7H41.1279L47.0033 35.7242H0L14.6885 21.3621L0 7Z' fill='#666666' />
        <path d='M247 7L205.875 7L200 36L247 36L232.312 21.5L247 7Z' fill={color} />
        <path opacity='0.7' d='M247 7L205.875 7L200 36L247 36L232.312 21.5L247 7Z' fill='#666666' />
